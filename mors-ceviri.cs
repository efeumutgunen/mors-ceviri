...
namespace ConsoleApplication8
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string yazitxttomors, yazimorstotxt, morsharfkontrol = "", ceviri = "", cevirimorstotext = "";
            char eh, ehmtt, ehanamenusecim, ehanamenusecimf;
            int secim;
        ...
        ikisecim:
            ...
            ceviri = "";
            Console.Clear();
            Console.WriteLine("Mors Çeviri Programı");
            Console.WriteLine("--------------------");
            ...
            switch (secim)
            {
                ...
                yenidenceviri:
                    ...
                    break;
                default:
                    Console.WriteLine("HATA: Sadece 1 ve 2 ile seçim yapabilirsiniz.");
                    goto ikisecim;
            }
        }
    }
